...
from src.financial.shared.thresholds import (
    DEBT_TO_INCOME_CRITICAL_THRESHOLD as _DEBT_TO_INCOME_CRITICAL_FRACTION,
    EMERGENCY_FUND_TARGET_MONTHS_THRESHOLD,
    SAVINGS_RATE_LOW_THRESHOLD as _SAVINGS_RATE_LOW_FRACTION,
    SAVINGS_RATE_STRONG_THRESHOLD as _SAVINGS_RATE_STRONG_FRACTION,
    SPENDING_CONCENTRATION_THRESHOLD as _SPENDING_CONCENTRATION_FRACTION,
)

SAVINGS_RATE_LOW_THRESHOLD = _SAVINGS_RATE_LOW_FRACTION * 100
SAVINGS_RATE_STRONG_THRESHOLD = _SAVINGS_RATE_STRONG_FRACTION * 100

EMERGENCY_FUND_MINIMAL_MONTHS_THRESHOLD = 1
EMERGENCY_FUND_STRONG_MONTHS_THRESHOLD = 6

DEBT_TO_INCOME_CRITICAL_THRESHOLD = _DEBT_TO_INCOME_CRITICAL_FRACTION * 100
